...
const wrapper1 = document.querySelector(".wrappe"),
toast2 = wrapper1.querySelector(".toas"),
title = toast2.querySelector("span"),
subTitle = toast2.querySelector("p"),
wifiIcon = toast2.querySelector(".ico"),
closeIcon = toast2.querySelector(".close-ico");
